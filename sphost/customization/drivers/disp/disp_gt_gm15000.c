...
#define CLK_1X      (CLK_NX/1)/*2600*/ /* 6136 75000 /3 or /4*/
#define CLK_NX    33000/*7800*/ /*24545*/ /*30000*//* Vsync */
#define SCL_CLK   198000/*117647 148500*/
#define FILTER_EVEN  /*DISP_UPS052_EVEN_BRG */DISP_UPS051_EVEN_RGB
#define FILTER_ODD   /*DISP_UPS052_ODD_BRG*/ DISP_UPS051_ODD_GBR
...
/* device open. */
#if DISP_UPS052 == 1
#define dispOpen  dispGtGm15000Ups520Open
...
#if SPCA5310
#if DISP_UPS052 == 1
static UINT8 dispDevName[] = "PANEL - GM15000_UPS052";
/*static UINT8 dispDevName[] = DEV_NAME; */
#endif
#else
#if DISP_UPS052 == 1
static UINT8 dispDevName[] = "LCD -GM15000_UPS052";
#endif
#endif
