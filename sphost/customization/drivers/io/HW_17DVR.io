...
;/* LCD PWR_BACKLIGHT2 nouse Isaac change PWR_BACKLIGHT lmi 3*/
PWR_BACKLIGHT  out dummy 0
PWR_LCD        out dummy 0

PWR_BACKLIGHT2 out dummy 0
PWR_BL_CTL     out dummy 0
LCD_RESET      out dummy 0

;/* LCD Serial Port LCD2_SPI_CS nouse Isaac*/
LCD_SLOAD    out dummy 0
LCD2_SPI_CS  out dummy 0
LCD_SPI_CS   out dummy 0
LCD_SCLK     out dummy 0
LCD_SDATA    out dummy 0
...
TV_DETECT    in tg 7
;#else
TV_DETECT    !in tg 7 /*tmep workaround for RAW+YUV PWDN2 pin*/
;#endif
TV_IN        out dummy 0
...
;/* LED */
;/* Isaac change pin define to lmi 4 & 18*/
LED_POWER           out 	lmi     18      0
LED_AF              out     dummy 0
LED_SELFTIMER       out     lmi     3      0

;/* SD Card Isaac changed SD_CARD_DETECT lmi 20  to lmi 13 SD_CARD_POWER fm 33 to lmi 12 */
SD_CARD_DETECT		!in	lmi	13	0
SD_CARD_WP		in dummy
SD_CARD_POWER		!out	lmi 	12	0 PU=0
SD_CARD_POWER_N		out	lmi 	14	1 PU=0
...
USB_DETECT          in usb 0
;/* Gensor */
GSENSOR_DETECT		in fm 24 0

;/*B Plus*/
BPLUS_DETECT		!in fm 1 PU=0
...
;/*Ethernet PHY*/
;/* Isaac modified to nouse*/
ETHERNET_PHY_PWR_EN out dummy 0
ETHERNET_PHY_INT        in dummy 0
...
;#elif (SP5K_SENSOR_GC4603)||(SP5K_SENSOR_SOIF02) || (SP5K_SENSOR_GC8603)
...
;/* Isaac change lmi 18 to dummy */
PCB_TEST2_EN        in dummy 0

;/* DRAM LDO */
DRAM_LDO_EN          out fm 32 0
DRAM_LDO_CLR         out tg 1 0
;/*HW WDT CLK Jet Isaac*/
HW_WDT_CLK 			out lmi 4 0
