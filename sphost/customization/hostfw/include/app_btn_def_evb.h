 ...
 *
 **************************************************************************/
#ifndef APP_BTN_EVB_DEF_H
#define APP_BTN_EVB_DEF_H
...
#define BTN_GRP_MATRIX		(((UINT32)0x4)<<BTN_SHIFT_GRP_CODE)
...
#define BTN_MSK_TV		(((UINT32)1)<<(BTN_ID_TV+BTN_SHIFT_GPIO_MSK))
#define BTN_MSK_USB		(((UINT32)1)<<(BTN_ID_USB+BTN_SHIFT_GPIO_MSK))
...
#if defined(HW_EVB_DSC18001A)
#define ADC_BTN_A_CH	SP5K_ADC_SARIN8 /* channel 8 for 4 way key */
#define ADC_BTN_B_CH	SP5K_ADC_SARIN4 /* channel 4 for other key */
#else
...
/* ADC setting */
#define ADC_BTN_A_S1        13376  /* UP */
#define ADC_BTN_A_S2        9996   /* DOWN */
#define ADC_BTN_A_S3        6158   /* LEFT */
#define ADC_BTN_A_S4        2769   /* RIGHT */

#define ADC_BTN_B_S1        13383  /* OK/MENU Key  */
#define ADC_BTN_B_S2        10012  /* F1 /DEL*/
#define ADC_BTN_B_S3        6162   /* F2 */
#define ADC_BTN_B_S4        2784   /* F3 */
