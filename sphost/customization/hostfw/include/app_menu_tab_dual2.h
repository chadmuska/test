...
#ifndef _MENU_TAB_DUAL2_H_
#define _MENU_TAB_DUAL2_H_
...
#define	MENU_MARK_LIGHTFREQ	0x04020000
#define	MENU_MARK_SlEEPTIME	0x04030000
#define	MENU_MARK_POWERONREC	0x04040000
#define	MENU_MARK_DATETIME	0x04050000
#define	MENU_MARK_LANGUAGE	0x04060000
#define	MENU_MARK_FORMAT	0x04090000
...
#define ID_STR_YES		0x0185
#define ID_STR_NO		0x0186
#define ID_STR_CARD_ERROR		0x0187
#define ID_STR_FORMAT		0x0188
#define ID_STR_UNPROTECT_THIS_FILE_		0x0189
#define ID_STR_UNPROTECT_ALL_FILES_		0x018a
#define ID_STR_PROTECT_THIS_FILE_		0x018b
#define ID_STR_PROTECT_ALL_FILES_		0x018c
#define ID_STR_PROTECT_UNPROTECT_FILE_		0x018d
#define ID_STR_DELETE_THIS_FILE_		0x018e
#define ID_STR_DETECTING_BLINKING___		0x018f
#define ID_STR_SAVE		0x0190
#define ID_STR_CROP_THIS_PHOTO_		0x0191
#define ID_STR_PLEASE_SELECT_FILETYPE_		0x0192
#define ID_STR_REDEYESAVE		0x0193
#define ID_STR_OVERWRITE		0x0194
#define ID_STR_SAVE_AS		0x0195
#define ID_STR_CALIBRATION		0x0196
#define ID_STR_CALIB_INFO		0x0197
#define ID_STR_OB_CLBT		0x0198
#define ID_STR_M_SHUTTER		0x0199
#define ID_STR_ISO_CLBT_LV11_		0x019a
#define ID_STR_DIFF_ISO_OB_CLBT		0x019b
#define ID_STR_WB_CLBT		0x019c
#define ID_STR_BACK		0x019d
#define ID_STR_CALIB_AWB		0x019e
#define ID_STR_CREAT_CTT		0x019f
#define ID_STR_CREAT_LV10_CALIBRATION		0x01a0
#define ID_STR_CREAT_LV10_STANDARD		0x01a1
#define ID_STR_FOCUS		0x01a2
#define ID_STR_FLASH		0x01a3
#define ID_STR_PRE_ANALYSES		0x01a4
#define ID_STR_H_POS_SCAN		0x01a5
#define ID_STR_DURATION_SCAN		0x01a6
#define ID_STR_VIEW_DPC		0x01a7
#define ID_STR_CAPTURE_DPC		0x01a8
#define ID_STR_BATTERY		0x01a9
#define ID_STR_BATTERY_TYPE		0x01aa
#define ID_STR_ALKALINE		0x01ab
#define ID_STR_NIMH		0x01ac
#define ID_STR_LITHIUM		0x01ad
#define ID_STR_OXYRIDE		0x01ae
#define ID_STR__CAM_CONFIG		0x01af
#define ID_STR_FW_UPDATE		0x01b0
#define ID_STR_FACTORY_DEFAULT		0x01b1
#define ID_STR_PV_SAVERAW		0x01b2
#define ID_STR_CAP_SAVERAW		0x01b3
#define ID_STR_RAWBATCH_ENABLE		0x01b4
#define ID_STR_PREFH_STAMP		0x01b5
#define ID_STR_AF_FULL_SCAN		0x01b6
#define ID_STR__TEST_BENCH		0x01b7
#define ID_STR_TEST_ROBOT		0x01b8
#define ID_STR__SENSOR		0x01b9
#define ID_STR_IRIS_DIFF_LV12		0x01ba
#define ID_STR_MINI_GAIN_LV12		0x01bb
#define ID_STR_PV_LV_4_16		0x01bc
#define ID_STR_CAP_LV_4_16		0x01bd
#define ID_STR_P2D		0x01be
#define ID_STR_CIPA		0x01bf
#define ID_STR_LCD_TEST		0x01c0
#define ID_STR_KEY_TEST		0x01c1
#define ID_STR_AE_METER		0x01c2
#define ID_STR__FLASH		0x01c3
#define ID_STR_CURVE_A0		0x01c4
#define ID_STR_CURVE_A1		0x01c5
#define ID_STR_CURVE_B0		0x01c6
#define ID_STR_CURVE_B1		0x01c7
#define ID_STR_P2___		0x01c8
#define ID_STR__AF		0x01c9
#define ID_STR_NOISE_CORING_VALUE_TEST		0x01ca
#define ID_STR_NOISE_CORING_THESHOLD_TEST		0x01cb
#define ID_STR_NOISE_THESHOID_TEST		0x01cc
#define ID_STR_BATTERY_CURVE		0x01cd
#define ID_STR_AE_DEBUG		0x01ce
#define ID_STR_AWB_DEBUG		0x01cf
#define ID_STR_USB_ISP		0x01d0
#define ID_STR_STAND_ALONE_LSC		0x01d1
#define ID_STR_PV_OB_CAL		0x01d2
#define ID_STR_VIDEO_REC_LOG		0x01d3
#define ID_STR_DIGITAL_ZOOM		0x01d4
#define ID_STR_ENTER		0x01d5
#define ID_STR_DELETE_ALL_FILES_		0x01d6
#define ID_STR_DELETE_FILES_		0x01d7
#define ID_STR_FORMATTING___		0x01d8
#define ID_STR_HAS_NO_SIZE_TO_RESIZE_		0x01d9
#define ID_STR_FILE_LOCKED_		0x01da
#define ID_STR_PROTECT_FILE_		0x01db
#define ID_STR_UNPROTECT_FILE_		0x01dc
#define ID_STR_PROTECT_ALL_		0x01dd
#define ID_STR_UNPROTECT_ALL_		0x01de
#define ID_STR_NO_FILE		0x01df
#define ID_STR_NO_CARD_		0x01e0
#define ID_STR_REMOVE_CARD_		0x01e1
#define ID_STR_WAITING___		0x01e2
#define ID_STR_CARD_LOCKED_		0x01e3
#define ID_STR_PAUSE		0x01e4
#define ID_STR_REC		0x01e5
#define ID_STR_FILE_ERROR_		0x01e6
#define ID_STR_PLEASE_PLUG_OUT_CARD		0x01e7
#define ID_STR_MEMORY_FULL		0x01e8
#define ID_STR_WAITING_FOR_PRINTER		0x01e9
#define ID_STR_NO_JPEG		0x01ea
#define ID_STR_FORMAT_FAIL_		0x01eb
#define ID_STR_LOW_BATTERY		0x01ec
#define ID_STR_OUT_OF_BATTERY		0x01ed
#define ID_STR_NOT_SUPPORT_		0x01ee
#define ID_STR_CANCEL		0x01ef
#define ID_STR_SELECT_UP_TO_24		0x01f0
#define ID_STR_PLEASE_SELECT_A_PICTURE		0x01f1
#define ID_STR_PRINT_ERROR		0x01f2
#define ID_STR_PRINTER_ERROR		0x01f3
#define ID_STR_NOT_FIND_PRINTER		0x01f4
#define ID_STR_PICTBRIDGE		0x01f5
#define ID_STR_SET_THIS_PHOTO_		0x01f6
#define ID_STR_SET_ALL_PHOTO_		0x01f7
#define ID_STR_REVIEW_THIS_FILE_		0x01f8
#define ID_STR_SAVE_THIS_FILE_		0x01f9
#define ID_STR_DELETE		0x01fa
#define ID_STR_ALL		0x01fb
#define ID_STR_SELECT		0x01fc
#define ID_STR_COPY_TO_CARD		0x01fd
#define ID_STR_COPY_THIS_FILE_		0x01fe
#define ID_STR_COPY_ALL_FILES_		0x01ff
#define ID_STR_ROTATE		0x0200
#define ID_STR_ROTATE_THIS_PHOTO_		0x0201
#define ID_STR_SET		0x0202
#define ID_STR_STOP		0x0203
#define ID_STR_DELETE_VOICE_MEMO_		0x0204
#define ID_STR_READY_TO_RECORD		0x0205
#define ID_STR_READY_TO_PLAY		0x0206
#define ID_STR_RECORDING_MEMO___		0x0207
#define ID_STR_PLAYING_AUDIO___		0x0208
#define ID_STR_TRIM_THIS_PHOTO_		0x0209
#define ID_STR_COPY_ERROR		0x020a
#define ID_STR_CAPTURE_NOT_ENOUGH_SIZE		0x020b
#define ID_STR_CAPTURE_DONE		0x020c
#define ID_STR_BUSY___PLEASE_WAIT		0x020d
#define ID_STR_NOT_AVAILABLE_FOR_THIS_FILE		0x020e
#define ID_STR_IMAGE_SAVED		0x020f
#define ID_STR_PAPER_SIZE		0x0210
#define ID_STR_PAPER_ERROR		0x0211
#define ID_STR_LOAD_ERROR		0x0212
#define ID_STR_EJECT_ERROR		0x0213
#define ID_STR_PAPER_JAM		0x0214
#define ID_STR_INK_EMPTY		0x0215
#define ID_STR_INK_LOW		0x0216
#define ID_STR_WASTE_INK		0x0217
#define ID_STR_FATAL_ERROR		0x0218
#define ID_STR_SERVICE_CALL		0x0219
#define ID_STR_PRINTER_BUSY		0x021a
#define ID_STR_LEVER_ERROR		0x021b
#define ID_STR_COVER_OPEN		0x021c
#define ID_STR_INK_COVER_OPEN		0x021d
#define ID_STR_NO_INK_CARTRIDGE		0x021e
#define ID_STR_INFO_ERROR		0x021f
#define ID_STR_USB_ERROR		0x0220
#define ID_STR_CONNECTING		0x0221
#define ID_STR_PRINTING___		0x0222
#define ID_STR_CANCELLING		0x0223
#define ID_STR_NO_PAPER		0x0224
#define ID_STR_PLAY		0x0225
#define ID_STR_DISPLAY_FILE		0x0226
#define ID_STR_COMPLETED		0x0227
#define ID_STR_NOT_SUPPORT_C2C		0x0228
#define ID_STR_FIND_START		0x0229
#define ID_STR_FIND_END		0x022a
#define ID_STR_AND_PRESS_OK		0x022b
#define ID_STR_WRITING_VIDEO		0x022c
#define ID_STR_WRITING_FILE_FAIL		0x022d
#define ID_STR_TRIM_VIDEO_IS_TOO_SHORT		0x022e
#define ID_STR_PB_TYPE		0x022f
#define ID_STR_VIDEO		0x0230
#define ID_STR_IMAGE		0x0231
#define ID_STR_BURST_LMT		0x0232
#define ID_STR_BURST_SUST		0x0233
#define ID_STR_MFNR		0x0234
#define ID_STR_PRESHOT		0x0235
#define ID_STR_ZEROSHOT		0x0236
#define ID_STR_0_5SEC		0x0237
#define ID_STR_MEMORY		0x0238
#define ID_STR_INTERNAL		0x0239
#define ID_STR_CARD		0x023a
#define ID_STR_USB		0x023b
#define ID_STR_FACE_BEAUTY		0x023c
#define ID_STR_SUPER_RESOLUTION		0x023d
#define ID_STR_USB_DONGLE		0x023e
#define ID_STR_SDIO		0x023f
#define ID_STR_WIFI_DEVICE		0x0240
#define ID_STR_INSUFFICIENT_DISK_SPACE		0x0241
#define ID_STR_MONO		0x0242
#define ID_STR_TOYCAM		0x0243
#define ID_STR_LIGHTTONE		0x0244
#define ID_STR_WAITING_FOR_CAPTURE		0x0245
#define ID_STR_WAITING_FOR_CARD		0x0246
#define ID_STR_FHD_720P		0x0247
#define ID_STR_FHD_VGA		0x0248
#define ID_STR_FHD_FHD		0x0249
#define ID_STR_TIME_LAPSE		0x024a
#define ID_STR_INVERT_MODE		0x024b
#define ID_STR_DISCONNECTING		0x024c
#define ID_STR_CARD_SPEED_SLOW		0x024d
#define ID_STR_POWER_ON_RECORD		0x024e
#define ID_STR_JPG		0x024f
#define ID_STR_EVENT		0x0250
#define ID_STR_PROTECT		0x0251
#define ID_STR_PROTECT_ALL		0x0252
#define ID_STR_UNPROTECT_ALL		0x0253
#define ID_STR_START_UP		0x0254
...
#define STRTK_BURST_LMT		ID_STR_BURST_LMT
#define STRTK_BURST_SUST		ID_STR_BURST_SUST
