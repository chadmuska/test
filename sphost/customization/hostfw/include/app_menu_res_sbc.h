...
#ifndef _MENU_RES_SBC_H_
#define _MENU_RES_SBC_H_
...
"Still Record",		"mode_still.bmp",		[()appMenuEvt_ModeStill],
	...
	"Photo Burst",		[(PhotoBurst)],
		...
		"Burst LMT 3",		"burst_3.bmp",		[(PhotoBurst)appMenuEvt_PhotoBurstSet],
		"Burst LMT 5",		"burst_5.bmp",		[(PhotoBurst)appMenuEvt_PhotoBurstSet],
...
"VideoMenu",		"mode_video.bmp",		[()appMenuEvt_ModeVideo],
	"Movie Size",		[(VideoSize)appMenuEvt_FisrstItemProcess],
		"1080P(60)",		"movie_size_1080p.bmp",		[appMenuAct_VideoSizeSet(VideoSize)appMenuEvt_VideoSizeSet],
		"1080P(30)",		"movie_size_1080p.bmp",		[(VideoSize)appMenuEvt_VideoSizeSet],
		"720P(30)",		"movie_size_720p.bmp",		[(VideoSize)appMenuEvt_VideoSizeSet],
		"4K2K",		"mode_video.bmp",		[appMenuAct_VideoSizeSet(VideoSize)appMenuEvt_VideoSizeSet],
		"2.7K",		"mode_video.bmp",		[appMenuAct_VideoSizeSet(VideoSize)appMenuEvt_VideoSizeSet],
	...
	"Seamless",		[appMenuAct_VideoSeamless(Seamless)],
	...
	"EIS",		[appMenuAct_EISMode(VideoEISMode)appMenuEvt_LastItemProcess],
		"Off",		"off.bmp",		[(VideoEISMode)appMenuEvt_VideoEISModeSet],
		"On",		"on.bmp",		[(VideoEISMode)appMenuEvt_VideoEISModeSet],
