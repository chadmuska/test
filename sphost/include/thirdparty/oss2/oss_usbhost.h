...
void* uvc_dev_open(int devno);
int uvc_dev_close(int devno);
int uvc_list_support_fmt_devno(int fmt);
int uvc_get_current_devno(void);
void uvc_set_current_devno(int devno);
int uvc_request_buf(void* uh, int num);
int uvc_query_buf(void* uh, int index, void **pbuf, int *len);
int uvc_queue_buf(void* uh, int index);
int uvc_dequeue_buf(void* uh, int *index, int *len);
int uvc_streamon(void* uh);
int uvc_streamoff(void* uh);
int uvc_set_current_configure(void* uh, int fmt, int width, int height, int interval);
int uvc_get_current_configure(void* uh, int *fmt, int *width, int *height, int *interval);
int uvc_list_support_configure(void* uh);
