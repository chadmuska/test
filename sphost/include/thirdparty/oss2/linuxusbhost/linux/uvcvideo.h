#ifndef _LINUX_UVC_VIDEO_H_
#define _LINUX_UVC_VIDEO_H_
...
#define UVC_CTRL_FLAG_GET_RANGE	(UVC_CTRL_FLAG_GET_CUR | UVC_CTRL_FLAG_GET_MIN | \
...
#define DRIVER_VERSION_CODE	0x010101
...
struct icatchtek_uvc_handle* get_uvc_handle(int devno);
int put_uvc_handle(int devno);
