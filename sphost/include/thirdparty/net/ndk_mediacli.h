...
{
	void *priv_data;
	int  (*mcli_start)  (struct NDKMediaCli *cli, int optnum, NDKMediaCliOpt *opts);
 ...
 * API Functions
 */
int  ndk_mediacli_start(NDKMediaCliHandle h, int optnum, NDKMediaCliOpt *opts);
...
/*
 * Flags for NDKMediaCliAVSink::pf_init.
 */
#define NDK_MEDIACLI_AVSNK_FLG_LIVE          MEDIA_SNK_FLG_LIVE
#define NDK_MEDIACLI_AVSNK_FLG_NOAUDSWAP     MEDIA_SNK_FLG_NO_AUDIO_SWAP
...
struct NDKMediaCliAVSink
{
	 ...
	 * SP5K_MEDIA_ATTR_AUDIO_AVG_BITRATE
	 */
