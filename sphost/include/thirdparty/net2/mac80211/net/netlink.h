...
#ifdef NETLINK_ATTR_H_
#error "conflict with libnl netlink/attr.h"
#endif

#ifdef nla_put
#error "nla_put is defined"
#endif
 ...
 */
static inline struct nlmsghdr *nlmsg_put_skb(struct sk_buff *skb, u32 portid, u32 seq,
...
static inline struct nlmsghdr *nlmsg_put_answer(struct sk_buff *skb,
						...
						int flags)
{
	return nlmsg_put_skb(skb, NETLINK_CB(cb->skb).nls_portid, cb->nlh->nlmsg_seq,
			 type, payload, flags);
}
...
///	return alloc_skb(nlmsg_total_size(payload), flags);
	return (struct sk_buff *)skbc_alloc(nlmsg_total_size(payload), NULL);
}
				  ...
				  u32 portid, unsigned int group, gfp_t flags)
{
	...
	NETLINK_CB(skb).nls_dst_group = group;
