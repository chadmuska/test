...
{
	NDK_ASSERT_EXPR(SKBC_HDR_SIZE(skb) >= sizeof(struct sk_buff),
		printf("%d %d\n", SKBC_HDR_SIZE(skb), sizeof(struct sk_buff)));
...
///	return false;
///}
#define ieee80211_vif_is_mesh(...)	(0)
...
{
///	mac80211_dbg_print("ieee80211_rx +++");
...
{
	struct ieee80211_hdr *hdr = (struct ieee80211_hdr *)SKBC_PTR(skb)->data;
