...
#define NET_RELEASE_VERSION "00.04.53"
#define NET_SVN_NUMBER "29981"
...
#if !defined(BASEFW_REVISION_CODE) || BASEFW_REVISION_CODE < 29980
#error Need basefw revision 29980 or higher.
#endif
