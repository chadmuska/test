...
enum {
	...
	NDK_MEDIACLI_RTP_OPT_NON_LIVE    = 1, /* 1: Non-Live streaming */
	NDK_MEDIACLI_RTP_OPT_AUDIO_ONLY  = 2, /* 1: Audio Only. Cannot coexist with option NDK_RTPCLI_OPT_VIDEO_ONLY. */
	NDK_MEDIACLI_RTP_OPT_VIDEO_ONLY  = 3, /* 1: Video Only. */
	NDK_MEDIACLI_RTP_OPT_GOPCHK      = 4, /* 1: Enable GOP checking */
	NDK_MEDIACLI_RTP_OPT_RTPDBG      = 5, /* 1: RTP verbosity */
	NDK_MEDIACLI_RTP_OPT_AVSNKDBG    = 6, /* 1: Enable AV sink debug. */
	NDK_MEDIACLI_RTP_OPT_CACHE_FIRST_ONLY = 7, /* 1: Cache first frame only. */
	...
	NDK_MEDIACLI_RTP_OPT_AVSYNCTIME  = 0x1002, /* Unit: ms. Default: 0. */
	NDK_MEDIACLI_RTP_OPT_DMXDROPTIME = 0x1003, /* Unit: ms. Default: 50. */
...
typedef void NDKMediaCliRtpMsgHandler(
